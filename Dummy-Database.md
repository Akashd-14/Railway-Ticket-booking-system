...
INSERT INTO RESERVATION.ADMIN VALUES('admin@demo.com','admin','System','Admin','Demo Address 123 colony','1234');
INSERT INTO RESERVATION.CUSTOMER VALUES('akash@demo.com','akash','akash','Raj','Kolkata, West Bengal',123456);

INSERT INTO RESERVATION.TRAIN VALUES(10001,'MAHALAXMI EXP','KOP','CST-MUM', 152, 490.50);
INSERT INTO RESERVATION.TRAIN VALUES(10002,'KOYANA EXP','KOP','DADAR', 52, 550.50);
INSERT INTO RESERVATION.TRAIN VALUES(10003,'SINGHGAD EXP','PUNE','CST-MUM', 92, 451);
...
INSERT INTO RESERVATION.HISTORY VALUES('BBC374-NSDF-4673','akash@demo.com',10001,TO_DATE('02-FEB-2024'), 'KOP','CST-MUM', 2, 981);
