...
INSERT INTO RESERVATION.CUSTOMER VALUES('akash@demo.com','akash','akash','Raj','Kolkata, West Bengal',954745222);
...
INSERT INTO RESERVATION.HISTORY VALUES('BBC374-NSDF-4673','akash@demo.com',10001,TO_DATE('02-FEB-2024'), 'HOWRAH', 'JODHPUR', 2, 981);
INSERT INTO RESERVATION.HISTORY VALUES('BBC375-NSDF-4675','akash@demo.com',10004,TO_DATE('12-JAN-2024'), 'RANCHI', 'PATNA', 1, 550);
INSERT INTO RESERVATION.HISTORY VALUES('BBC373-NSDF-4674','akash@demo.com',10006,TO_DATE('22-JULY-2024'), 'PATNA', 'DELHI', 3, 4352.25);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri  > Paste The Repository Url: ```https://github.com/Akashd-14/Railway-Ticket-booking-system.git``` > Next > Select Main Branch > Next > Finish
...
Step 8: Default Username And Password For User Is "akash@demo.com" And "akash"
...
11. Fare Enquiry
<img alt="Fare Enquiry between stations" src="https://github.com/Akashd-14
Railway-Ticket-booking-system/blob/master/Screenshots/fareenquiry.png" width="100%">

12. Change Password
<img alt="Change user Password" src="https://github.com/Akashd-14
Railway-Ticket-booking-system/blob/master/Screenshots/passwordchange.png" width="100%">

13. Add Trains By Admin
<img alt="Admin Home" src="https://github.com/Akashd-14
Railway-Ticket-booking-system/blob/master/Screenshots/addtrains.png" width="100%">
